    ...
    <div class="w3-col m12 card-box ">
        <div class="w3-round w3-white">
            <div class="w3-container w3-padding">
                <h4>Formulir Ubah Data Siswa</h4>
                <hr class="w3-clear">
                <form name="simpan" method="post" enctype="multipart/form-data">  
                    <div class="w3-row">
                        <div class="w3-col m6 w3-row-padding">
                            ...
                            <img src="siswa_photo/<?php echo $data_siswa['photo'];?>" class="w3-margin-bottom" alt="Photo" style="width:100px;height:100px;"> 
                ...
                if(isset($_POST['simpan'])){
                    ...
                    if($tmp=="" and $file_upload==""){
                        ...
                        if(move_uploaded_file($tmp, $path)){ 
                            ...
                            if(is_file("siswa_photo/".$dt['photo'])) unlink("siswa_photo/".$dt['photo']);
