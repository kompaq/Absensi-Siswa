...
if ($_SESSION['nama_pengguna']) {
  $akun = $_SESSION['nama_pengguna'];
  $cariakun =  mysqli_query($conn, "SELECT * FROM tbl_guru WHERE nama_pengguna='$akun'");
...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  <a href="?page=home" class="w3-bar-item w3-button w3-padding-large">Administrasi Guru</a>
        ...
        <div class="w3-container panel">
          <div class="">
            ...
            <?php 
                  if($row_data['photo']==""){
                ?>
                  <img src="guru_photo/defauld.png" alt="Photo" style="width:50%;">
                <?php }else{ ?>
                  <img src="guru_photo/<?php echo $row_data['photo'];?>" alt="Photo" style="width:50%;">
                <?php } ?>
              </p>
            <hr>
            ...
            <a href="?page=edit_profil&id_guru=<?php echo $row_data['id_guru'];?>" class="w3-button w3-white w3-border w3-margin-bottom w3-right"><i class="fas fa-user-edit"></i> Edit</a>         
          </div>
        </div>
      </div>
